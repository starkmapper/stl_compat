...
function(ensure_nuget_program)
  find_program(nuget_program NAMES nuget PATHS ${CMAKE_BINARY_DIR}/nuget.exe)
  if(${nuget_program} STREQUAL "nuget_program-NOTFOUND")
    download_nuget()
    find_program(nuget_program NAMES nuget ${CMAKE_BINARY_DIR}/nuget.exe)
  endif()
...
function(ensure_nuget_packagedir)
  if ("${nuget_packagedir}" STREQUAL "")
    ...
    if (NOT "${_gbl_packagedir}" MATCHES "global-packages")
      message(FATAL_ERROR "Could not determine nuget global packages directory in output: program: ${nuget_program} dir: ${_gbl_packagedir}, result: ${_gbl_result}")
    endif()
