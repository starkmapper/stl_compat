...
function(ensure_nuget_package package_name package_version)
  if("${${package_name}_PACKAGE_DIR}" STREQUAL "")
    ensure_nuget_program()
    ensure_nuget_packagedir()
    set(package_dir ${nuget_packagedir}/${package_name}/${package_version})
    ...
    set(${package_name}_PACKAGE_DIR ${package_dir} CACHE PATH "${package_name} v${package_version} package directory.")
  endif()
